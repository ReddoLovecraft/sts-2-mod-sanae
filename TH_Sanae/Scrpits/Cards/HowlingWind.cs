...
namespace TH_Sanae.Scrpits.Cards
{
	...
	public sealed class HowlingWind : SanaeCardModel
	{
		public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Exhaust];
		protected override IEnumerable<DynamicVar> CanonicalVars => [new CardsVar(14)];
		...
		public HowlingWind() : base(2, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
		{
		}
		...
		protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
		{
			...
			await PowerCmd.Apply<HowlingWindPower>(choiceContext, Owner.Creature, 2, Owner.Creature, this);
		}
